...
[RStudio](http://www.rstudio.com/) es un excelente entorno de desarrollo integrado
construido específicamente para [R](http://cran.us.r-project.org/). También contiene
el control de versiones de Git y SVN.


### Configración de RStudio
