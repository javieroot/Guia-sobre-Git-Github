...
El siguiente paso será instalar git, lo cual depende del sistema operativo 


Antes de pasar a explicar el proceso de enlace del pc con Github quiero dejar algo
claro. Git es un programa que se instala en nuestro pc (hasta ahí todo claro supongo,
pero hay que tener en cuenta que no todos los programas tienen una interfaz gráfica (gui).
En el caso de linux y mac no hay gui (aunque sí hay programas externos que permite
manejar git a través de una gui) y en windows git sí viene incluido con una gui.
Sin embargo, tanto en mac como en windows, **no** es recomendable trabajar con git
mediante una interfaz gráfica. En vez de eso se trabajará mediante línea de comandos
por terminal (en linux y mac) y cmd (en windows). 
...
(sustituir "your\_email@youremail.com" por el email que se puso al crear la cuenta de github).
...
## Integración de Git y Github con RStudio

A continuación, se muestra cómo utilizar Git y GitHub con Rstudio

### ¿Qué es [RStudio](http://www.rstudio.com/)?

Es un excelente entorno de desarrollo integrado construido específicamente para 
[R](http://cran.us.r-project.org/). También contiene el control de versiones de 
Git y SVN.


### Configuración de RStudio

Abrir Rstudio y establecer la ruta de ejecutable de Git. Ir a Herramientas > Opciones > Git/SVN

![Sin titulo](imagenes/imagen1.png)

Es importante encontrar el archivo git.exe (como se muestra arriba). Este puede 
estar ubicado en cualquier número de lugares en función del sistema operativo,
pero la ubicación de la instalación de Git es un buen primer lugar para buscar.

![Sin titulo](imagenes/imagen2.png)
![Sin titulo](imagenes/imagen3.png)
![Sin titulo](imagenes/imagen4.png)
![Sin titulo](imagenes/imagen5.png)

## Fuentes

El presente documento es una recopilación de las siguientes páginas:

[Hispano](https://github.com/Hispano/Guia-sobre-Git-Github-y-Metodologia-de-Desarrollo-de-Software-usando-Git-y-Github)

[THE MOLECULAR ECOLOGIST](http://www.molecularecologist.com/2013/11/using-github-with-r-and-rstudio/)
